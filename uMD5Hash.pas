...
function MD5File(N: RawByteString): MD5Digest;
function MD5Print(D: MD5Digest): RawByteString; 
...
begin
        MD5Init(Context);
        FileHandle := CreateFileA(PAnsiChar(N), GENERIC_READ, FILE_SHARE_READ or FILE_SHARE_WRITE,
