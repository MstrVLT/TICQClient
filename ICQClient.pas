...
type
  ...
  TOnPktParseAdv = procedure(Sender: TObject; Host: RawByteString;  Port: Word; Buffer: Pointer; BufLen: LongWord; Incoming: Boolean) of object;
  TOnHandlePkt = procedure(Flap: TFlapHdr; Buffer: Pointer) of object;
  TOnServerDisconnect = procedure(Sender: TObject; Reason: LongInt; Description: RawByteString) of object; // yegor
  TOnMsgProc = procedure(Sender: TObject; Msg, UIN: RawByteString) of object;
  TOnWPagerProc = procedure(Sender: TObject; PSender,PEmail,PSenderIP, Msg:RawByteString) of object;     // Added by Saif.N
  TOnOffMsgProc = procedure(Sender: TObject; DateTime: TDateTime; Msg, UIN: RawByteString) of object;
  TOnURLProc = procedure(Sender: TObject; Description, URL, UIN: RawByteString) of object;
  TOnOffURLProc = procedure(Sender: TObject; DateTime: TDateTime; Description, URL, UIN: RawByteString) of object;
  TOnStatusChange = procedure(Sender: TObject; UIN: RawByteString;  Status: LongWord) of object;
  TOnOnlineInfo = procedure(Sender: TObject; UIN: RawByteString;  Port: Word; InternalIP, ExternalIP: RawByteString;  OnlineTime: TDateTime; IdleTime: Word; ICQVersion, MirandaVersion: LongWord; ProtoVer: Byte; UserCaps: RawByteString;  AvatarId: Word; AvatarFlags: Byte; AvatarHash: RawByteString;  NewXStatusSet : Boolean; NewXStatusMoodNum : Byte; NewXStatusNote : RawByteString) of object; // yegor
  TOnUserEvent = procedure(Sender: TObject; UIN: RawByteString) of object;
  TOnUserGeneralInfo = procedure(Sender: TObject; UIN, NickName, FirstName, LastName, Email, City, State, Phone, Fax, Street, Cellular, Zip, Country: RawByteString;  TimeZone: Byte; PublishEmail: Boolean) of object;
  TOnUserWorkInfo = procedure (Sender: TObject; UIN, WCity, WState, WPhone, WFax, WAddress, WZip, WCountry, WCompany, WDepartment, WPosition, WOccupation, WHomePage: RawByteString) of object;
  TOnUserInfoMore = procedure (Sender: TObject; UIN: RawByteString;  Age: Word; Gender: Byte; HomePage: RawByteString;  BirthYear: Word; BirthMonth: Word; BirthDay: Word; Lang1, Lang2, Lang3: RawByteString) of object;
  TOnUserInfoAbout = procedure(Sender: TObject; UIN, About: RawByteString) of object;
  TOnUserInfoInterests = procedure(Sender: TObject; UIN: RawByteString;  Interests: TStringList) of object;
  TOnUserInfoMoreEmails = procedure(Sender: TObject; UIN: RawByteString;  Emails: TStringList) of object;
  TOnUserInfoBackground = procedure(Sender: TObject; UIN: RawByteString;  Pasts, Affiliations: TStringList) of object;
  TOnUserFound = procedure(Sender: TObject; UIN, Nick, FirstName, LastName, Email: RawByteString;  Status: Word; Gender, Age: Byte; SearchComplete: Boolean; Authorize: Boolean) of object;
  TOnServerListRecv = procedure(Sender: TObject; SrvContactList: TList) of object;
  TOnAdvMsgAck = procedure(Sender: TObject; UIN: RawByteString;  ID: Word; AcceptType: Byte; AcceptMsg: RawByteString) of object;
  TOnMsgAck = procedure(Sender: TObject; UIN: RawByteString;  ID: Word) of object;
  TOnAutoMsgResponse = procedure(Sender: TObject; UIN: RawByteString;  ID: Word; RespStatus: Byte; Msg: RawByteString) of object;
  TOnContactListRecv = procedure(Sender: TObject; UIN: RawByteString;  ContactList: TStringList) of object;
  TOnContactListReq = procedure(Sender: TObject; UIN, Reason: RawByteString) of object;
  TOnDirectPktAck = procedure(Sender: TObject; ID: Word) of object;
  TOnSMSAck = procedure(Sender: TObject; Source, Network, MsgId: RawByteString;  Deliverable: Boolean) of object;
  TOnSMSReply = procedure(Sender: TObject; Source, SmsSender, Time, Text: RawByteString) of object;
  TOnInfoChanged = procedure(Sender: TObject; InfoType: TInfoType; ChangedOk: Boolean) of object;
  TOnAuthResponse = procedure(Sender: TObject; UIN: RawByteString;  Granted: Boolean; Reason: RawByteString) of object;
  TOnChangeResponse = procedure(Sender: TObject; Id:Cardinal; ErrorCode: Word) of object;
  TOnUploadAvatarOk = procedure(Sender: TObject; AvatarId:Cardinal; Hash: RawByteString) of object;
  ...
  TOnUserInfoShort = procedure(Sender: TObject; UIN, NickName, FirstName, LastName, Email: RawByteString;  UserFound, AuthRequired: Boolean) of object;
  TOnAuthRequest = procedure(Sender: TObject; UIN: RawByteString;  Reason: RawByteString) of object;
  TOnICBMError = procedure(Sender: TObject; ErrorCode: Word) of object;
  TOnTypingNotification = procedure(Sender: TObject;  UIN: RawByteString;  NotificationType: Word) of object; //by ok3y
  TOnAvatarReceive = procedure(Sender: TObject; UIN: RawByteString;  AvatarId: Word; AvatarFlags: Byte; AvatarHash, AvatarData, AvatarExt : RawByteString) of object; //by ok3y
  ...
  private
    ...
    FHost: RawByteString; 
    FHostViaHTTP: RawByteString;  // yegor
    FPortViaHTTP: Integer;
    FPort: Word;

    FProxyType: TProxyType;
    FProxyHost: RawByteString; 
    FProxyPort: Word;
    ...
    FHTTPSid: RawByteString; 
    FHTTPIP: RawByteString; 
    FHTTPPort: Word;
    FHTTPSeq: Word;
    ...
    procedure _OnError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: RawByteString);
    ...
    procedure _OnICQSocketThreadException(Sender: TObject; AExceptionStr: RawByteString);
  ...
  public
    ...
    property HostViaHTTP: RawByteString  read FHostViaHTTP write FHostViaHTTP; // yegor
    ...
    property ProxyHost: RawByteString  read FProxyHost write FProxyHost;
  ...
  private
    ...
    FLPass: RawByteString;                                      //Client's password
    ...
    FCookie: RawByteString;                                     //Temporary cookie, used in login sequence, we can use String type, becouse ICQ server doesn't send 0x00 chars in it's Cookie part
    FSSBICookie : RawByteString; 
    FHost: RawByteString;  // yegor                             //Host to connect to
    FHostViaHTTP: RawByteString;  // yegor                      //Host to connect to when HTTP proxy
    FPort: Word;                                        //Port to connect to
    FDConnCookie: LongWord;                             //Direct connection cookie
    FDirect: TDirectControl;                            //Direct control
    FAvatarFileName : RawByteString; 
    FAvatarId : Word;
    //-- Proxy settings
    FProxyType: TProxyType;                             //.
    FProxyHost: RawByteString;                                  //.
    ...
    FLastInfoUin: RawByteString; 
    FLastSInfoUin: RawByteString; 
    FLoggedIn: Boolean;
    FRegisteringUIN: Boolean;
    FRegPassword: RawByteString; 
    ...
    procedure OnIntError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: RawByteString);
    ...
    procedure FTOnPktParse(Sender: TObject; Host: RawByteString;  Port: Word; Buffer: Pointer; BufLen: LongWord; Incoming: Boolean);
    procedure OnFTInitProc(Sender: TObject; UIN: LongWord; FileCount, TotalBytes, Speed: LongWord; NickName: RawByteString);
    procedure OnFTStartProc(Sender: TObject; StartRec: TFTStartRec; FileName: RawByteString;  FileSize, Speed: LongWord);
    procedure OnFTFileDataProc(Sender: TObject; UIN: LongWord; Data: Pointer; DataLen: LongWord; LastPacket: Boolean);
    procedure FTOnSocketThreadException(Sender: TObject; AExceptionStr: RawByteString);
    ...
    procedure FOnExtServiseError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: RawByteString);
  public
    ...
    procedure LogOff;
    procedure RegisterNewUIN(const Password: RawByteString);
    procedure Disconnect;
    procedure SendMessage(UIN: LongWord; const Msg: RawByteString);
    procedure SendURL(UIN: LongWord; const URL, Description: RawByteString);
    ...
    procedure RequestAvatar(UIN: RawByteString;  AvatarId: Word; AvatarFlags: Byte; AvatarHash: RawByteString);
    procedure RequestInfo(UIN: LongWord);
    procedure RequestInfoShort(UIN: LongWord);
    procedure SearchByMail(const Email: RawByteString);
    procedure SearchByUIN(UIN: LongWord);
    procedure SearchByName(const FirstName, LastName, NickName, Email: RawByteString);
    procedure SearchRandom(Group: Word);
    procedure SearchWhitePages(const FirstName, LastName, NickName, Email: RawByteString;  MinAge, MaxAge: Word; Gender: Byte; const Language, City, Country, Company, Department, Position, Occupation, Organization, OrganKeyWords, PastAffiliation, AffiKeyWords, KeyWord: RawByteString;  Online: Boolean);

    procedure SetSelfInfo(
      NickName, FirstName, LastName, Email, City, State, Phone, Fax, Street, Cellular, Zip: RawByteString; 
      Country: Word; TimeZone: Byte; PublishEmail: Boolean;
      Age: Word; Gender: Byte; const HomePage: RawByteString;  BirthYear: Word; BirthMonth, BirthDay: Byte;
      Language1, Language2, Language3: RawByteString;  const About: RawByteString; 
      AuthorizationRequired, WebAware: Boolean
    );
    procedure SetSelfInfoGeneral(NickName, FirstName, LastName, Email, City, State, Phone, Fax, Street, Cellular, Zip: RawByteString;  Country: Word; TimeZone: Byte; PublishEmail: Boolean);
    procedure SetSelfInfoMore(Age: Word; Gender: Byte; const HomePage: RawByteString;  BirthYear: Word; BirthMonth, BirthDay: Byte; Language1, Language2, Language3: RawByteString);
    procedure SetSelfInfoAbout(const About: RawByteString);
    ...
    procedure SendSMS(const Destination, Text: RawByteString);
    procedure SendMessageAdvanced(UIN: LongWord; const Msg: RawByteString;  ID: Word; RTFFormat: Boolean);
    procedure SendTypingNotification(UIN: RawByteString;  NotificationType: Word); //ok3y
    procedure SendYouWereAdded(UIN: LongWord);
    function SendMessageDirect(UIN: LongWord; const Msg: RawByteString;  RTFFormat: Boolean): Word;
    Function SendFileDC(UIN:LongWord; FileName, Description:RawByteString): Word;
    ...
    procedure SetNewXStatus(NewStat: T_NewXStatus; NewStr: RawByteString);
    procedure SetNewXStatusByICQMoodNum(ICQMoodNum: Byte; NewStr: RawByteString);

    procedure UpdateCapabilities;

    procedure MaskIntoQIP(BuildNum : LongWord);

    procedure UnregisterUIN(const Password: RawByteString);
    function  UploadAvatar(FileName: RawByteString): Word;
    function  DeleteAvatar(Id: Word): Boolean;
    procedure ChangePassword(const NewPassword: RawByteString);
    ...
    function RequestContacts(UIN: LongWord; const Reason: RawByteString;  ID: Word): Boolean;
    function SendContactsDC(UIN: LongWord; Contacts: TStringList): Word;
    function RequestContactsDC(UIN: LongWord; const Reason: RawByteString): Word;
    procedure RequestExtService;
    procedure SendKeepAlive;
    procedure SendAuthRequest(UIN: LongWord; Msg: RawByteString);
    procedure SendAuthResponse (aUIN: LongWord; aAuthorize: Boolean; aReason: RawByteString);
    procedure SSLActivate;  //added by Volkov Ioann
    procedure SSLChangeStart(FirstUpload: Boolean);
    procedure SSLChangeEnd;
    procedure SSLAddGroup(GroupName: RawByteString;  GroupID: Word);
    procedure SSLAddUser(GroupID, UserID: Word; UIN, Name, SMSNumber: RawByteString;  Authorize, UpdateUser: Boolean);
    procedure SSLDelUser(GroupID, UserID: Word; UIN, Name, SMSNumber: RawByteString;  Authorize: Boolean);
    procedure SSLDelGroup(GroupName: RawByteString;  GroupID: Word);
    procedure SSLUpdateGroup(GroupName: RawByteString;  GroupID: Word; UserIDs: TStringList);
    procedure SSLAddUserIntoList(UserID: Word; UIN: RawByteString;  BuddyType: Word);
    procedure SSLDelUserFromList(UserID: Word; UIN: RawByteString;  BuddyType: Word);
    function FTResponse(ResponseRec: TFTRequestRec; Accept: Boolean; Reason: RawByteString): Boolean;
  ...
  published
    ...
    property ProxyHost: RawByteString  read FProxyHost write FProxyHost;
    property ProxyPort: Word read FProxyPort write FProxyPort;
    property ProxyUserID: RawByteString  read FProxyUser write FProxyUser;
    property ProxyResolve: Boolean read FProxyResolve write FProxyResolve default False;
    property ProxyAuth: Boolean read FProxyAuth write FProxyAuth default False;
    property ProxyPass: RawByteString  read FProxyPass write FProxyPass;
    property SecureLogin: Boolean read FSecureLogin write FSecureLogin;
    property UIN: LongWord read FLUIN write FLUIN;
    property Password: RawByteString  read FLPass write FLPass;
    property ErrorLanguage: TICQLangType read FErrLang write SetErrorLang default LANG_EN;
    property ICQServer: RawByteString  read FHost write FHost; // yegor
    property ICQServerViaHTTP: RawByteString  read FHostViaHTTP write FHostViaHTTP; // yegor
    ...
    property AutoAwayMessage: RawByteString  read FAutoAwayMsg write FAutoAwayMsg;
...
procedure TICQNet._OnError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: RawByteString);
begin
...
begin
  if Sender = FSocket then begin
    ...
    {$IFDEF HTTP_DEBUG}
    LogText('http.txt', 'Received (send-proxy): '#13#10 + PAnsiChar(Buffer));
    {$ENDIF}
    FCanSend := False;
    HTTPResend;
  end;
...
procedure TICQClient.OnIntError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: RawByteString);
begin
  FLastError := ErrorMsg;
  if Assigned(OnError) then
    FOnError(Self, ErrorType, ErrorMsg);
...
{Registers a new UIN.}
procedure TICQClient.RegisterNewUIN(const Password: RawByteString);
begin
...
procedure TICQClient.SendMessage(UIN: LongWord; const Msg: RawByteString);
var
  pkt: TRawPkt;
begin
...
procedure TICQClient.SendURL(UIN: LongWord; const URL, Description: RawByteString);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SearchByMail(const Email: RawByteString);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SearchByName(const FirstName, LastName, NickName, Email: RawByteString);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SearchWhitePages(const FirstName, LastName, NickName, Email: RawByteString;  MinAge, MaxAge: Word;
  Gender: Byte; const Language, City, Country, Company, Department, Position, Occupation,
  Organization, OrganKeyWords, PastAffiliation, AffiKeyWords, KeyWord: RawByteString;  Online: Boolean);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SetSelfInfoGeneral(NickName, FirstName, LastName, Email, City, State, Phone, Fax, Street, Cellular, Zip : RawByteString;  Country: Word; TimeZone: Byte; PublishEmail: Boolean);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SetSelfInfoMore(Age: Word; Gender: Byte; const HomePage: RawByteString;  BirthYear: Word; BirthMonth, BirthDay: Byte; Language1, Language2, Language3: RawByteString);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SetSelfInfoAbout(const About: RawByteString);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SendSMS(const Destination, Text: RawByteString);
var
  pkt: TRawPkt;
begin
...
procedure TICQClient.SendMessageAdvanced(UIN: LongWord; const Msg: RawByteString;  ID: Word; RTFFormat: Boolean);
var
  pkt: TRawPkt;
begin
...
procedure TICQClient.SendTypingNotification(UIN: RawByteString; 
...
function TICQClient.SendMessageDirect(UIN: LongWord; const Msg: RawByteString;  RTFFormat: Boolean): Word;
var
  lpkt: TRawPkt;
begin
  Result := 0;
...
procedure TICQClient.UnregisterUIN(const Password: RawByteString);
var
  pkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQClient.ChangePassword(const NewPassword: RawByteString);
var
  pkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
function TICQClient.RequestContacts(UIN: LongWord; const Reason: RawByteString;  ID: Word): Boolean;
var
  pkt: TRawPkt;
begin
  Result := False;
...
Function TICQClient.SendFileDC(UIN:LongWord; FileName, Description:RawByteString): Word;
Var
  Pkt:TRawPkt;
...
function TICQClient.RequestContactsDC(UIN: LongWord; const Reason: RawByteString): Word;
var
  lpkt: TRawPkt;
begin
  Result := 0;
...
procedure TICQClient.SendAuthRequest(UIN: LongWord; Msg: RawByteString);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQCLient.SendAuthResponse (aUIN: LongWord; aAuthorize: Boolean; aReason: RawByteString);
var
   Pkt: TRawPkt;
begin
     if not LoggedIn
...
{Add group to SSL.}
procedure TICQClient.SSLAddGroup(GroupName: RawByteString;  GroupID: Word);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
{Add user to SSL.}
procedure TICQClient.SSLAddUser(GroupID, UserID: Word; UIN, Name, SMSNumber: RawByteString;  Authorize, UpdateUser: Boolean);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQClient.SSLDelUser(GroupID, UserID: Word; UIN, Name, SMSNumber: RawByteString;  Authorize: Boolean);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQClient.SSLDelGroup(GroupName: RawByteString;  GroupID: Word);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
{Update group's ids.}
procedure TICQClient.SSLUpdateGroup(GroupName: RawByteString;  GroupID: Word; UserIDs: TStringList);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQClient.SSLAddUserIntoList(UserID: Word; UIN: RawByteString;  BuddyType: Word);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQClient.SSLDelUserFromList(UserID: Word; UIN: RawByteString;  BuddyType: Word);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
function TICQClient.FTResponse(ResponseRec: TFTRequestRec; Accept: Boolean; Reason: RawByteString): Boolean;
var
  lpkt: TRawPkt;
begin
...
var
  FUIN: RawByteString; 
  FData, FIpPort, FValue: RawByteString; 
  pkt: TRawPkt;
  T: Word;
  Snac: TSnacHdr;
  i, Cnt: Word;
  ...
  SSBIHost, SSBIPort: RawByteString; 
...
var
  ...
  extIP: DWORD;
  wAck: Word;
  Desc, URL: RawByteString; 
  v: Byte;
  atype: RawByteString; 
  XML: RawByteString; 
  XMLTime, XMLSource, XMLSender, XMLText: RawByteString; 
  FName, FDesc: RawByteString; 
  FSize: LongWord;
  FFSeq, FFSeq2: Word;
  Rec: TFTRequestRec;
  TCMD: RawByteString; 
  List: TStringList;
  PSender, PEmail, PSenderIP: RawByteString; 
  Request: Boolean;
  TlvType:Word;
  TlvCount: Word;
begin
...
var
  ...
  FLang1, FLang2, FLang3, FAbout: RawByteString; 
  FTimeZone: Byte;
  FPublishEmail: Boolean;
  FAge, FYear: Word;
  FGender, FMonth, FDay: Byte;
  Msg, UIN, URL, Desc: RawByteString; 
  ...
  cmd: Word;
  seq: Word;
  FSmsSource, FSmsDeliverable, FSmsNetwork, FMsgId: RawByteString; 
  FAuthorize: Byte;
...
procedure TICQClient.HSnac030B(Flap: TFlapHdr; Snac: TSnacHdr; Pkt: PRawPkt);
  function NumToIp(Addr: LongWord): RawByteString; 
  var
    inaddr: in_addr;
  begin
    inaddr.S_addr := Addr;
...
var
  ...
  NewXStatusNote, tlvDat, tmpStr : RawByteString; 
...
procedure TICQClient.FTOnPktParse(Sender: TObject; Host: RawByteString;  Port: Word; Buffer: Pointer; BufLen: LongWord; Incoming: Boolean);
begin
  if Assigned(OnPktParse) then
    FOnPktParse(Self, TICQNet(Sender).Host, TICQNet(Sender).Port, Buffer, BufLen, Incoming);
end;

procedure TICQClient.OnFTInitProc(Sender: TObject; UIN: LongWord; FileCount, TotalBytes, Speed: LongWord; NickName: RawByteString);
begin
  if Assigned(OnFTInit) then
    FOnFTInit(Self, UIN, FileCount, TotalBytes, Speed, NickName);
end;

procedure TICQClient.OnFTStartProc(Sender: TObject; StartRec: TFTStartRec; FileName: RawByteString;  FileSize, Speed: LongWord);
begin
...
function DigestToBuff(Digest: Md5Digest): RawByteString; 
var
  I: Integer;
begin
...
begin
  ...
  MD5Init(State);
  MD5Update(State, PAnsiChar(Password), length(Password));
  MD5Final(State, Digest);

  MD5Init(State);
  MD5Update(State, PAnsiChar(Key), KeyLen );
  MD5Update(State, PAnsiChar(DigestToBuff(Digest)), SizeOf(Md5Digest) );
  MD5Update(State, PAnsiChar(CLIENT_MD5_String), length(CLIENT_MD5_String));
  MD5Final(State, Digest);
...
function DetectAvatarFormat(AvatarData: RawByteString) : TAvatarFormat;
begin
...
var
  ...
  AvatarFlags : Byte;
  AvatarHash : RawByteString; 
  AvatarData : RawByteString; 
  AvatarExt : RawByteString; 
//  i: Integer;
begin
  try
    UIN := GetLStr(Pkt);
...
procedure TICQClient.FOnExtServiseError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: RawByteString);
begin
  FExtServiceReady := False;
  Sleep(50);
  RequestExtService;
...
procedure TICQClient.RequestAvatar(UIN: RawByteString;  AvatarId: Word;
  AvatarFlags: Byte; AvatarHash: RawByteString);
var
  pkt: TRawPkt;
begin
...
function TICQClient.UploadAvatar(FileName: RawByteString) : Word;
var
  pkt: TRawPkt;
  TLVs: TRawPkt;
  h : Md5Digest;
...
procedure TICQClient.SetNewXStatus(NewStat: T_NewXStatus; NewStr: RawByteString);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SetNewXStatusByICQMoodNum(ICQMoodNum: Byte; NewStr: RawByteString);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
