...
type
  TOnErrorEvent = procedure(Sender: TObject; Reason: Word; ReasonStr: RawByteString) of object;
  ...
  TOnContact = procedure(Sender: TObject; UIN: LongWord; NickName, FirstName, LastName,
    Email: RawByteString;  Age, Gender: Byte; LastUpdate: RawByteString;  LastUpdateStamp: LongWord) of object;
  TOnSelfInfo = procedure(Sender: TObject; UIN: LongWord; NickName, FirstName, LastName,
    Email, Password: RawByteString;  Age, Gender: Byte; LastUpdate: RawByteString;  LastUpdateStamp: LongWord) of object;
  TOnMessage = procedure(Sender: TObject; UIN: LongWord; Incoming: Boolean; Msg, RecvTime: RawByteString;  RecvTimeStamp: LongWord) of object;
  TOnUrl = procedure(Sender: TObject; UIN: LongWord; Incoming: Boolean; Description, URL, RecvTime: RawByteString;  RecvTimeStamp: LongWord) of object;
  TOnAdvMessage = procedure(Sender: TObject; UIN: LongWord; Incoming: Boolean; PlainText, RichText, UTF8Text, RecvTime: RawByteString;  RecvTimeStamp: LongWord) of object;
  ...
  private
    FIdxFile, FDatFile: RawByteString; 
    ...
    function ReadStr(Handle: THandle; Len: LongWord): RawByteString; 
    function ReadLNTS(Handle: THandle): RawByteString; 
    ...
    function OpenIdx(const FileName: RawByteString): Boolean;
    procedure CloseIdx;
    function OpenDat(const FileName: RawByteString): Boolean;
    procedure CloseDat;
  ...
  published
    property DatFile: RawByteString  read FDatFile write FDatFile;
...
implementation
function TimeStamp2Str(Timestamp: LongWord): RawByteString; 
var
  DelphiTime: Double;
begin
...
function TICQDb.ReadStr(Handle: THandle; Len: LongWord): RawByteString; 
var
  buf: Pointer;
  read: LongWord;
begin
...
function TICQDb.ReadLNTS(Handle: THandle): RawByteString; 
begin
...
function TICQDb.OpenIdx(const FileName: RawByteString): Boolean;
begin
  Result := False;
  CloseIdx;
...
function TICQDb.OpenDat(const FileName: RawByteString): Boolean;
begin
  Result := False;
  CloseDat;
...
function Read6bh: RawByteString; 
begin
...
var
  FNickName: RawByteString; 
  FFirstName: RawByteString; 
  FLastName: RawByteString; 
  FEmail: RawByteString; 
  FLastUpdate: RawByteString; 
  FAge, FGender: Byte;
  FUIN: LongWord;
  FMsg, FMsg2, FMsg3: RawByteString; 
  FFlag: LongWord;
  FSeparator: Word;
  FSubType: Word;
  FTStamp: LongWord;
...
function GetModuleName(Ofs: LongWord): RawByteString; 
type
...
function ReadASCIIZ: RawByteString; 
begin
