...
Type
  ...
  TicqDCM = Class(TObject)
    Private
      ...
      procedure InternalOnErrorProc(Sender: TObject; ErrorType: TErrorType; ErrorMsg: RawByteString); virtual;
    ...
    Public
      ...
      property ProxyUserID: RawByteString  read FUserID write FUserID;
  ...
  TicqBaseDC = Class(TObject)
    Protected
      ...
      procedure OnIntError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: RawByteString); virtual;
    Public
      EventType:Integer;
      MyUIN:LongWord;
...
Function IPToStr(aIP:LongWord):RawByteString; 
Var
  HV:RawByteString; 
Begin
  HV := IntToHex(aIP, 8);
...
procedure TicqDCM.InternalOnErrorProc(Sender: TObject; ErrorType: TErrorType; ErrorMsg: RawByteString);
Begin
...
procedure TicqBaseDC.OnIntError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: RawByteString);
Begin
  If Assigned(fOnError) Then
    fOnError(Sender, ErrorType, ErrorMsg);
End;
