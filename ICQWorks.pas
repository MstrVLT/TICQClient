...
type
  ...
  TSendFileRec = Record
    ...
    FilesCount:LongWord;
    FilePath:RawByteString; 
    FileName:RawByteString; 
    FileDescription:RawByteString; 
    FileSize:LongWord;
    TotalSize:LongWord;
    Port:Word;
    Speed:Byte;
  ...
  TOnFTInit = procedure(Sender: TObject; UIN: LongWord; FileCount, TotalBytes, Speed: LongWord; NickName: RawByteString) of object;
  TOnFTStart = procedure(Sender: TObject; StartRec: TFTStartRec; FileName: RawByteString;  FileSize, Speed: LongWord) of object;
...
function IntToStr(Value: Int64): RawByteString; 
function StrToInt(const Value: RawByteString): LongWord;
function IntToHex(Int: Int64; IntSize: Byte): RawByteString; 
function HexToInt(Value: RawByteString): LongWord;
procedure ICQEncryptPass(SrcBuf: Pointer; BufLen: LongWord);
procedure ICQEncryptPassStr(var Pass: RawByteString);
function Swap16(Value: Word): Word;
function Swap32(Value: LongWord): LongWord;
function iif(ACondition: Boolean; AIfTrue, AIfFalse: RawByteString): RawByteString; 
...
procedure PktStr(Pkt: PRawPkt; const S: RawByteString);
procedure PktLStr(Pkt: PRawPkt; const S: RawByteString); overload;
procedure PktLStr(Pkt: PRawPkt; S: LongWord); overload;
procedure PktWStr(Pkt: PRawPkt; const S: RawByteString);
procedure PktDWStr(Pkt: PRawPkt; const S: RawByteString);
procedure PktLNTS(Pkt: PRawPkt; const S: RawByteString);
procedure PktLLNTS(Pkt: PRawPkt; const S: RawByteString);
procedure PktTLV(Pkt: PRawPkt; T, L: Word; V: LongWord); overload;
procedure PktTLV(Pkt: PRawPkt; T: Word; const V: RawByteString); overload;
procedure PktTLV(Pkt: PRawPkt; T, L: Word; V: Pointer); overload;
procedure PktLTLV(Pkt: PRawPkt; T: Word; const V: RawByteString); overload;
procedure PktLTLV(Pkt: PRawPkt; T,L: Word; V: LongWord); overload;
procedure PktLBTLV(Pkt: PRawPkt; T: Word; V: RawByteString;  B: Byte); overload;

{-- Extracting data --}
function GetInt(Pkt: PRawPkt; IntSize: Byte): LongWord;
function GetLInt(Pkt: PRawPkt; IntSize: Byte): LongWord;
function GetStr(Pkt: PRawPkt; StrLen: Integer): RawByteString; 
function GetTLVStr(Pkt: PRawPkt; var T: Word): RawByteString; 
function GetTLVInt(Pkt: PRawPkt; var T: Word): LongWord;
procedure GetSnac(Pkt: PRawPkt; var Snac: TSnacHdr);
function GetLStr(Pkt: PRawPkt): RawByteString; 
function GetWStr(Pkt: PRawPkt): RawByteString; 
function GetDWStr(Pkt: PRawPkt): RawByteString; 
function GetLNTS(Pkt: PRawPkt): RawByteString; 


{High-level functions}
function StrToLanguageI(const Value: RawByteString): Word;
function StrToCountryI(const Value: RawByteString): Word;
function StrToInterestI(const Value: RawByteString): Word;
function StrToOccupationI(const Value: RawByteString): Word;
function StrToPastI(const Value: RawByteString): Word;
function StrToOrganizationI(const Value: RawByteString): Word;
procedure ParseContacts(Value: RawByteString;  var List: TStringList);
function MakeContactsStr(Contacts: TStringList): RawByteString; 

{Packet creation functions}

procedure CreateCLI_SSL_ACTIVATE(Pkt: PRawPkt; var Seq, Seq2: Word); {CLI_ROSTERACK}

procedure CreateCLI_IDENT(Pkt: PRawPkt; UIN: LongWord; Password: RawByteString;  Secure: Boolean; var Seq: Word);
procedure CreateCLI_COOKIE(Pkt: PRawPkt; const Cookie: RawByteString;  var Seq: Word);
...
procedure CreateCLI_SETNEWXSTATUS(Pkt: PRawPkt; XStat: T_NewXStatus; XStatStr: RawByteString;  var Seq: Word);
procedure CreateCLI_SETNEWXSTATUS_icqmood(Pkt: PRawPkt; MoodNum: Byte; XStatStr: RawByteString;  var Seq: Word);
...
procedure CreateCLI_REQ_AVATAR(Pkt: PRawPkt; UIN: RawByteString;  var FSeq: Word; AvatarId: Word; AvatarFlags: Byte; AvatarHash: RawByteString);
procedure CreateCLI_TOICQSRV(Pkt: PRawPkt; UIN: LongWord; Command: Word; Data: Pointer; DataLen: LongWord; var Seq, Seq2: Word);
procedure CreateCLI_ADDCONTACT(Pkt: PRawPkt; UIN: RawByteString;  var Seq: Word);
...
procedure CreateCLI_SENDMSG(Pkt: PRawPkt; ITime, IRandom, UIN: LongWord; const Msg: RawByteString;  var Seq: Word);
procedure CreateCLI_SENDURL(Pkt: PRawPkt; ITime, IRandom, MyUIN, UIN: LongWord; const URL, Description: RawByteString;  var Seq: Word);
procedure CreateCLI_AUTHORIZE(Pkt: PRawPkt; UIN: LongWord; Auth: Byte; Reason: RawByteString;  var Seq: Word);
procedure CreateCLI_METAREQINFO(Pkt: PRawPkt; UIN, dUIN: LongWord; var Seq, Seq2: Word);
procedure CreateCLI_SEARCHBYMAIL(Pkt: PRawPkt; UIN: LongWord; const Email: RawByteString;  var Seq, Seq2: Word);
procedure CreateCLI_SEARCHBYUIN(Pkt: PRawPkt; UIN: LongWord; DUIN: LongWord; var Seq, Seq2: Word);
procedure CreateCLI_SEARCHBYNAME(Pkt: PRawPkt; UIN: LongWord; const FirstName, LastName, NickName, Email: RawByteString;  var Seq, Seq2: Word);
procedure CreateCLI_SEARCHRANDOM(Pkt: PRawPkt; UIN: LongWord; Group: Word; var Seq, Seq2: Word);
procedure CreateCLI_SEARCHWP(Pkt: PRawPkt; UIN: LongWord; First, Last, Nick, Email: RawByteString;  MinAge, MaxAge: Word; Gender: Byte; Language: Byte; City: RawByteString;  Country: Word; Company, Department, Position: RawByteString;  Occupation: Byte; Organization: Word; OrganKeyWords: RawByteString;  Affiliation: Word; AffiKeyWords, KeyWord: RawByteString;  Online: Byte; var Seq, Seq2: Word);
...
procedure CreateCLI_METASETMORE(Pkt: PRawPkt; UIN: LongWord; Age: Word; Gender: Byte; HomePage: RawByteString;  BirthYear: Word; BirthMonth, BirthDay, Lang1, Lang2, Lang3: Byte; var Seq, Seq2: Word);

procedure CreateCLI_METASETGENERAL(Pkt: PRawPkt; UIN: LongWord; const NickName, FirstName, LastName, Email, City, State, Phone, Fax, Street, Cellular, Zip: RawByteString;  Country: Word; TimeZone: Byte; PublishEmail: Boolean; var Seq, Seq2: Word);

procedure CreateCLI_METASETABOUT(Pkt: PRawPkt; UIN: LongWord; const About: RawByteString;  var Seq, Seq2: Word);
procedure CreateCLI_SENDSMS(Pkt: PRawPkt; UIN: LongWord; const Destination, Text: RawByteString;  CodePage: Word; const Time: RawByteString;  var Seq, Seq2: Word);
procedure CreateCLI_SENDMSG_ADVANCED(Pkt: PRawPkt; Status: LongWord; ITime, IRandom, UIN: LongWord; const Msg: RawByteString;  RTFFormat: Boolean; var Seq: Word);
procedure CreateCLI_SENDMSG_FILEACK(Pkt: PRawPkt; Status: LongWord; FFSeq: Word; ITime, IRandom, UIN, FileSize: LongWord; const FileDesc, FileName: RawByteString;  Port: Word; var Seq: Word);
procedure CreateCLI_SENDMSG_FILEDECLINE(Pkt: PRawPkt; FFSeq: Word; ITime, IRandom, UIN, FileSize: LongWord; const FileDesc, FileName, Reason: RawByteString;  Port: Word; var Seq: Word);
procedure CreateCLI_HELLO(Pkt: PRawPkt; var Seq: Word);
procedure CreateCLI_GOODBYE(Pkt: PRawPkt; var Seq: Word);
procedure CreateCLI_REGISTERUSER(Pkt: PRawPkt; const Password: RawByteString;  var Seq: Word);
...
procedure CreateCLI_SENDCONTACTS_REQ(Pkt: PRawPkt; Status: LongWord; ITime, IRandom, UIN: LongWord; Reason: RawByteString;  var Seq: Word);
procedure CreateCLI_UNREGUIN(Pkt: PRawPkt; UIN: LongWord; const Password: RawByteString;  var Seq, Seq2: Word);
procedure CreateCLI_METASETPASS(Pkt: PRawPkt; UIN: LongWord; const Password: RawByteString;  Buffer: Pointer; BufLen: Word; var Seq, Seq2: Word);
...
procedure CreateCLI_REQAUTH(Pkt: PRawPkt; UIN: LongWord; Msg: RawByteString;  var Seq: Word);
...
procedure CreateCLI_UPDATEGROUP(Pkt: PRawPkt; Name: RawByteString;  Tag: Word; IDs: TStringList; var Seq: Word);
procedure CreateCLI_UPDATEBUDDY(Pkt: PRawPkt; UIN, Name, SMSNumber: RawByteString;  Tag, ID: Word; BuddyType: Word; NotAuthorized: Boolean; var Seq: Word);
procedure CreateCLI_ADDBUDDY(Pkt: PRawPkt; UIN, Name, SMSNumber: RawByteString;  Tag, ID: Word; BuddyType: Word; NotAuthorized: Boolean; var Seq: Word);
procedure CreateCLI_DELETEBUDDY(Pkt: PRawPkt; UIN, Name, SMSNumber: RawByteString;  Tag, ID: Word; BuddyType: Word; NotAuthorized, IsGroup: Boolean; var Seq: Word);
procedure CreateCLI_SEND_YOU_WERE_ADDED(Pkt: PRawPkt; ITime, IRandom, UIN, FromUIN: LongWord; var Seq: Word);
procedure CreateCLI_TYPING_NOTIFICATION(Pkt: PRawPkt; UIN: RawByteString; 
  NotificationType: Word; var Seq: Word); //ok3y
procedure CreateCLI_MD5AUTHREQ(Pkt: PRawPkt; UIN: RawByteString;  var Seq: Word); //ok3y

{Misc functions}
function SnacToStr(Family, SubType: Word): RawByteString; 
function SrvMetaToStr(V1, V2: Word): RawByteString; 
function PeerCmdToStr(Cmd: Byte): RawByteString; 
function DumpPacket(Buffer: Pointer; BufLen: Word): RawByteString; 
function UnicodeCharCode2ANSIString (aCode: Word): RawByteString;  // yegor
function RTF2Plain (const aSource: RawByteString): RawByteString;  // yegor
function StatusToInt(Value: LongWord): LongWord;   // added by eraser 30.6.03
function StatusToStr(Value: LongWord): RawByteString;      // changed by eraser 30.6.03
function StatusToStr_rus(Value: LongWord): RawByteString;  //added by Volkov Ioann
function CountryToStr(Value: Word): RawByteString; 
function LanguageToStr(Value: Byte): RawByteString; 
function OccupationToStr(Value: Word): RawByteString; 
function InterestToStr(Value: Word): RawByteString; 
function PastToStr(Value: Word): RawByteString; 
function AffiliationToStr(Value: Word): RawByteString; 
function LoadPacketRaw(Pkt: PRawPkt; const FName: RawByteString): Boolean;
function LoadPacket(Pkt: PRawPkt; const FName: RawByteString;  var Flap: TFlapHdr; var Snac: TSnacHdr): Boolean;
function FileExists(const FileName: RawByteString): Boolean;
function FileSize(const FName: RawByteString): LongWord;
procedure LogText(const FName, Text: RawByteString);
procedure ShowMessage(const Value: RawByteString); overload;
procedure ShowMessage(Value: LongInt); overload;
function ExtractName(const Value: RawByteString): RawByteString; 
function ExtractValue(const Value: RawByteString): RawByteString; 
function UTF8ToStr(Value: RawByteString): RawByteString; 
function UTF8ToStrSmart(Value: RawByteString): RawByteString; 
function MyUTF8Decode(Value : RawByteString) : RawByteString; 
function UCS2BEToStr (Value: RawByteString): RawByteString;  // yegor
function IsStringProbablyUCS2BE (aString: RawByteString): Boolean; // yegor
function StrToHexStr(AStr: RawByteString): RawByteString; 
function HexStrToStr(AStr: RawByteString): RawByteString; 

function GetXMLEntry(const Tag, Msg: RawByteString): RawByteString; 

{SMS functions}
function StrToUTF8(Value: RawByteString): RawByteString; 
function STime: RawByteString; 
function GetSMSTime: RawByteString; 
...
function CreatePEER_MSG(Pkt: PRawPkt; const Msg: RawByteString;  RTFFormat: Boolean; var Seq: Word): Word;
...
procedure CreatePEER_AUTOMSG_ACK(Pkt: PRawPkt; Answer: RawByteString;  Status, Seq: Word);
function CreatePEER_CONTACTS(Pkt: PRawPkt; Contacts: TStringList; var Seq: Word): Word;
function CreatePEER_CONTACTREQ(Pkt: PRawPkt; const Reason: RawByteString;  var Seq: Word): Word;
function CreatePEER_FILEINIT(Pkt: PRawPkt; Response: Boolean; FileDescription, FileName: RawByteString;  Port: Word; FileLength: LongWord; var Seq: Word; Reason: RawByteString;  Accept: Boolean): Word;
procedure CreatePEER_FILEINITACK(Pkt: PRawPkt; Speed: LongWord; Nick: RawByteString);
procedure CreatePEER_FILE_INIT(Pkt: PRawPkt; Count, Bytes, Speed: LongWord; Nick:RawByteString);
procedure CreatePEER_FILE_INIT2(Pkt: PRawPkt; Count, Bytes, Speed: LongWord);
procedure CreatePEER_FILE_START(Pkt: PRawPkt; FileName:RawByteString;  FileSize, Speed:LongWord);
...
function CreateHTTP_Header(const Method, URL, Host: RawByteString;  DataLen: LongWord; Auth: Boolean; User, Password: RawByteString): RawByteString; 
...
function CreateHTTP_INIT(Auth: Boolean; User, Password: RawByteString): RawByteString; 
function CreateHTTP_RECV(Host, SID: RawByteString;  Auth: Boolean; User, Password: RawByteString): RawByteString; 
procedure CreateHTTP_LOGIN(Pkt: PRawPkt; Host: RawByteString;  Port: Word);


function Decrypt99bPassword(UIN, CryptIV: LongWord; const HexPass: RawByteString): RawByteString; 
function DecryptMirandaPassword(const Value: RawByteString): RawByteString; 
...
begin
  ...
  while StrLen > 0 do
  begin
    Result := Result + PAnsiChar(LongWord(Pkt) + Pkt^.Len)^;
    Inc(Pkt^.Len);
    Dec(StrLen);
    if Pkt^.Len > 8100 then Exit;
  end;
...
function GetNewXStatus(st: T_NewXStatus): RawByteString; 
var
  i: Word;
begin
...
procedure CreateCLI_SEARCHWP(Pkt: PRawPkt; UIN: LongWord; First, Last, Nick, Email: RawByteString;  MinAge, MaxAge: Word;
  Gender: Byte; Language: Byte; City: RawByteString;  Country: Word; Company, Department, Position: RawByteString; 
  Occupation: Byte; Organization: Word; OrganKeyWords: RawByteString;  Affiliation: Word; AffiKeyWords,
  KeyWord: RawByteString;  Online: Byte; var Seq, Seq2: Word);
var
  lpkt: TRawPkt;
begin
...
procedure CreateCLI_SENDADVMSG_CUSTOM(Pkt: PRawPkt; Status: LongWord; FFSeq: Word;
  ...
  const Msg: RawByteString;  Data: Pointer; DataLen: LongWord; RTFFormat: Boolean;
...
procedure __CreateCLI_UPDATEBUDDY(Pkt: PRawPkt; A: Byte; UIN, Name, SMSNumber: RawByteString;  Tag, ID: Word; BuddyType: Word; NotAuthorized, IsGroup: Boolean; var Seq: Word);
var
  TLVs: TRawPkt;
begin
  PktInit(Pkt, 2, Seq);                         //Channel 2
...
function UnicodeCharCode2ANSIString (aCode: Word): RawByteString; 
var
...
function RTF2Plain (const aSource: RawByteString): RawByteString; 
var
   Source: RawByteString; 
   NChar: Integer;

function ProcessGroupRecursevly: RawByteString; 
...
var
   Control, NumericValue, TextValue: RawByteString; 
begin
     Result:='';
     Inc (NChar);
...
function StatusToStr(Value: LongWord): RawByteString; 
...
procedure ShowMessage(const Value: RawByteString); overload;
begin
  MessageBoxA(0, PAnsiChar(Value), 'Message', 0);
end;

procedure ShowMessage(Value: LongInt); overload;
begin
  MessageBoxA(0, PAnsiChar(IntToStr(Value)), 'Message', 0);
end;
...
function UCS2BEToStr (Value: RawByteString): RawByteString; 
var
   NWord: LongInt;
begin
     Result:='';
...
function IsStringProbablyUCS2BE (aString: RawByteString): Boolean;
var
...
begin
  ...
  recv_bytes := GetTimeFormatA(LANG_ENGLISH, TIME_FORCE24HOURFORMAT,
    @SysTime, PAnsiChar('HH:mm:ss'), @buf, SizeOf(buf));
