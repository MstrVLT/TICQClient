...
type
  ...
  TTranslateFunction = function(ResID: LongWord): RawByteString; 
  TICQLangNode = record
    Lang: TICQLangType;
    Translate: TTranslateFunction;
  end;
  function LangEn(ResID: LongWord): RawByteString; 
  function LangRu(ResID: LongWord): RawByteString; 
  function LangHu(ResID: LongWord): RawByteString; 
  function LangNo(ResID: LongWord): RawByteString; 
  function LangDe(ResID: LongWord): RawByteString; 
...
implementation
  ...
  function LangHu(ResID: LongWord): RawByteString;  // Translated by Mickey (mickey777@mail.datanet.hu)
  begin
    case ResID of
      {ICQClient}
  ...
  function LangNo(ResID: LongWord): RawByteString;  // Translated by Dan Michael (danm@start.no)
  begin
    case ResID of
      {ICQClient}
